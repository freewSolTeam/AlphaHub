...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!profile) {
    return { title: "Operator not found - AlphaHub" };
  }
  const name = profile.user.name || "Operator";
  return {
    title: `${name} - Operator Profile`,
    description: `${name}'s AlphaHub Degens, views, and sales earnings.`,
  };
}
  ...
  return (
    <div className="app-main-container pb-10 pt-6 sm:pb-12 sm:pt-8">
      <header className="mb-4 sm:mb-5">
        ...
        <p className="ui-form-hint mt-2 max-w-xl">Operator profile, Degens, and sales earnings.</p>
      </header>
