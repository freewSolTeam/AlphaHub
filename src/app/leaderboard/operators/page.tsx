...
export const metadata: Metadata = {
  title: "All Operators - AlphaHub",
  description: "Full leaderboard of all AlphaHub users ranked by listing views.",
};
    ...
    <div className="app-main-container pb-10 pt-6 sm:pb-12 sm:pt-8">
      <header className="mb-4 sm:mb-5">
        ...
        <p className="ui-form-hint mt-2 max-w-xl">
          Every AlphaHub user ranked by total listing views.
        </p>
      </header>
