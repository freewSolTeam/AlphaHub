...
export const priceCurrencySchema = z.enum(["USDG", "ETH"]);
...
export const projectFormSchema = z.object({
  ...
  priceCurrency: priceCurrencySchema.default("USDG"),
  ...
  telegram: optUrl,
  discord: optUrl,
  /// Supergroup id for the AlphaHub Telegram kick bot (e.g. -1001234567890)
...
export function normalizeProjectForm(input: ProjectForm) {
  ...
  const currency = isPaid ? (input.priceCurrency === "ETH" ? "ETH" : "USDG") : undefined;
