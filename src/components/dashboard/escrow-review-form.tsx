      ...
      <div className={compact ? "space-y-1" : "space-y-1.5"}>
        ...
        {opReply && repliedAt ? (
          <div
            className={
              compact
                ? "rounded border border-brand/15 bg-brand/10 px-2 py-1.5"
                : "rounded-md border border-brand/15 bg-brand/10 px-3 py-2"
            }
          >
            <p
              className={
                compact
                  ? "text-xs font-medium uppercase tracking-wide text-brand/80"
                  : "text-xs font-medium uppercase tracking-wide text-brand/80 sm:text-sm sm:tracking-wider"
              }
            >
